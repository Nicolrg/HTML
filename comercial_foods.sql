...
CREATE TABLE `empleado` (
  ...
  `sexo` enum('matculino','femenino') DEFAULT NULL,
  ...
  `nivel_estudio` enum('primaria','bachiller','tecnico','tecnologo','profecional','otro') DEFAULT NULL,
  `eps` enum('sanitas','sura','capital salud','nueva eps','compensar','famisanar','aliansalud') DEFAULT NULL,
  `pensiones` enum('colfondos','proteccion','porveni','skandia') DEFAULT NULL,
  `cesantias` enum('fna','porvenir','colfondo','proteccion') DEFAULT NULL,
  `banco` enum('BBVA','davivienda','balcolombia','caja social','popular','las villas') DEFAULT NULL,
